...
void main() {
  test('generates TransactionsDatabaseMock ObjectBox fixture', () async {
    final Directory outputDirectory = Directory(p.join('test', 'mocks', 'transactionsDatabaseMockWithPassword', 'objectbox_mock'));
    final File outputDatabaseFile = File(p.join('test', 'mocks', 'transactionsDatabaseMockWithPassword', 'objectbox_mock.mdb'));
