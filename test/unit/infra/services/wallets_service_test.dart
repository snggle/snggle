...
void main() {
  ...
  group('Tests of WalletsService.getAllByParentPath()', () {
    test('Should [return List of WalletModel] [given path HAS VALUES] (firstLevelBool == FALSE)', () async {
      ...
      List<WalletModel> expectedWalletModelList = <WalletModel>[
        // @formatter:off
        WalletModel(id: 1, encryptedBool: false, pinnedBool: false, address: '0x4BD51C77E08Ac696789464A079cEBeE203963Dce', derivationPath: "m/44'/60'/0'/0/0", filesystemPath: FilesystemPath.fromString('vault1/network1/wallet1'), name: 'WALLET 0', networkId: 1),
        WalletModel(id: 2, encryptedBool: false, pinnedBool: false, address: '0xd5fb453b321901a1d74Ba3FE93929AED57CA8686', derivationPath: "m/44'/60'/0'/0/1", filesystemPath: FilesystemPath.fromString('vault1/network1/wallet2'), name: 'WALLET 1', networkId: 1),
        WalletModel(id: 3, encryptedBool: false, pinnedBool: false, address: '0x1C37924f1416fF39F74A7284429a18dbbbcc06CD', derivationPath: "m/44'/60'/0'/0/2", filesystemPath: FilesystemPath.fromString('vault1/network1/wallet3'), name: 'WALLET 2', networkId: 1),
  ...
  group('Tests of WalletsService.move()', () {
    test('Should [MOVE wallet] if [wallet EXISTS] in database', () async {
      ...
      List<WalletEntity> expectedWalletsDatabaseValue = <WalletEntity>[
        // @formatter:off
        const WalletEntity(id: 1, encryptedBool: false, pinnedBool: false, address: '0x4BD51C77E08Ac696789464A079cEBeE203963Dce', derivationPath: "m/44'/60'/0'/0/0", filesystemPathString: 'new/wallet/path/wallet1', name: 'WALLET 0', networkId: 1),
        const WalletEntity(id: 2, encryptedBool: false, pinnedBool: false, address: '0xd5fb453b321901a1d74Ba3FE93929AED57CA8686', derivationPath: "m/44'/60'/0'/0/1", filesystemPathString: 'vault1/network1/wallet2', name: 'WALLET 1', networkId: 1),
        const WalletEntity(id: 3, encryptedBool: false, pinnedBool: false, address: '0x1C37924f1416fF39F74A7284429a18dbbbcc06CD', derivationPath: "m/44'/60'/0'/0/2", filesystemPathString: 'vault1/network1/wallet3', name: 'WALLET 2', networkId: 1),
        const WalletEntity(id: 4, encryptedBool: false, pinnedBool: false, address: '0x315C3d389598EAe9aA2bf5524556B9CFA857B97c', derivationPath: "m/44'/60'/0'/0/3", filesystemPathString: 'vault1/network1/group3/wallet4', name: 'WALLET 3', networkId: 1),
        const WalletEntity(id: 5, encryptedBool: false, pinnedBool: false, address: '0x569f256904bBaA2d9Cb3AF3104fCE9f0fC43F639', derivationPath: "m/44'/60'/0'/0/4", filesystemPathString: 'vault1/network1/group3/wallet5', name: 'WALLET 4', networkId: 1)
        // @formatter:on
      ];
  ...
  group('Tests of WalletsService.moveAllByParentPath()', () {
    test('Should [MOVE wallets] with provided parent path', () async {
      ...
      List<WalletEntity> expectedWalletsDatabaseValue = <WalletEntity>[
        // @formatter:off
        const WalletEntity(id: 1, encryptedBool: false, pinnedBool: false, address: '0x4BD51C77E08Ac696789464A079cEBeE203963Dce', derivationPath: "m/44'/60'/0'/0/0", filesystemPathString: 'vault1/network1/wallet1', name: 'WALLET 0', networkId: 1),
        const WalletEntity(id: 2, encryptedBool: false, pinnedBool: false, address: '0xd5fb453b321901a1d74Ba3FE93929AED57CA8686', derivationPath: "m/44'/60'/0'/0/1", filesystemPathString: 'vault1/network1/wallet2', name: 'WALLET 1', networkId: 1),
        const WalletEntity(id: 3, encryptedBool: false, pinnedBool: false, address: '0x1C37924f1416fF39F74A7284429a18dbbbcc06CD', derivationPath: "m/44'/60'/0'/0/2", filesystemPathString: 'vault1/network1/wallet3', name: 'WALLET 2', networkId: 1),
        const WalletEntity(id: 4, encryptedBool: false, pinnedBool: false, address: '0x315C3d389598EAe9aA2bf5524556B9CFA857B97c', derivationPath: "m/44'/60'/0'/0/3", filesystemPathString: 'new/wallet/path/wallet4', name: 'WALLET 3', networkId: 1),
        const WalletEntity(id: 5, encryptedBool: false, pinnedBool: false, address: '0x569f256904bBaA2d9Cb3AF3104fCE9f0fC43F639', derivationPath: "m/44'/60'/0'/0/4", filesystemPathString: 'new/wallet/path/wallet5', name: 'WALLET 4', networkId: 1)
        // @formatter:on
      ];
  ...
  group('Tests of WalletsService.save()', () {
    test('Should [UPDATE wallet] if [wallet EXISTS] in database', () async {
      ...
      List<WalletEntity> expectedWalletsDatabaseValue = <WalletEntity>[
        // @formatter:off
        const WalletEntity(id: 1, encryptedBool: true, pinnedBool: true, address: '0x0000000000000000000000000000000000000000', derivationPath: "m/44'/60'/0'/0/0", filesystemPathString: 'vault1/network1/wallet1', name: 'UPDATED WALLET 0', networkId: 1),
        const WalletEntity(id: 2, encryptedBool: false, pinnedBool: false, address: '0xd5fb453b321901a1d74Ba3FE93929AED57CA8686', derivationPath: "m/44'/60'/0'/0/1", filesystemPathString: 'vault1/network1/wallet2', name: 'WALLET 1', networkId: 1),
        const WalletEntity(id: 3, encryptedBool: false, pinnedBool: false, address: '0x1C37924f1416fF39F74A7284429a18dbbbcc06CD', derivationPath: "m/44'/60'/0'/0/2", filesystemPathString: 'vault1/network1/wallet3', name: 'WALLET 2', networkId: 1),
        const WalletEntity(id: 4, encryptedBool: false, pinnedBool: false, address: '0x315C3d389598EAe9aA2bf5524556B9CFA857B97c', derivationPath: "m/44'/60'/0'/0/3", filesystemPathString: 'vault1/network1/group3/wallet4', name: 'WALLET 3', networkId: 1),
        const WalletEntity(id: 5, encryptedBool: false, pinnedBool: false, address: '0x569f256904bBaA2d9Cb3AF3104fCE9f0fC43F639', derivationPath: "m/44'/60'/0'/0/4", filesystemPathString: 'vault1/network1/group3/wallet5', name: 'WALLET 4', networkId: 1)
    ...
    test('Should [SAVE wallet] if [wallet NOT EXISTS] in database', () async {
      ...
      List<WalletEntity> expectedWalletsDatabaseValue = <WalletEntity>[
        ...
        const WalletEntity(id: 4, encryptedBool: false, pinnedBool: false, address: '0x315C3d389598EAe9aA2bf5524556B9CFA857B97c', derivationPath: "m/44'/60'/0'/0/3", filesystemPathString: 'vault1/network1/group3/wallet4', name: 'WALLET 3', networkId: 1),
        const WalletEntity(id: 5, encryptedBool: false, pinnedBool: false, address: '0x569f256904bBaA2d9Cb3AF3104fCE9f0fC43F639', derivationPath: "m/44'/60'/0'/0/4", filesystemPathString: 'vault1/network1/group3/wallet5', name: 'WALLET 4', networkId: 1),
        const WalletEntity(id: 999999, encryptedBool: true, pinnedBool: true, address: '0x0000000000000000000000000000000000000000', derivationPath: "m/44'/60'/0'/0/0", filesystemPathString: 'vault1/network1/wallet999999', name: 'NEW WALLET 0', networkId: 1)
        // @formatter:on
      ];
  ...
  group('Tests of WalletsService.saveAll()', () {
    test('Should [UPDATE wallets] if [wallets EXISTS] in database', () async {
      ...
      List<WalletModel> actualWalletsToUpdate = <WalletModel>[
        // @formatter:off
        WalletModel(id: 1, encryptedBool: true, pinnedBool: true, address: '0x0000000000000000000000000000000000000000', derivationPath: "m/44'/60'/0'/0/0", filesystemPath: FilesystemPath.fromString('vault1/network1/wallet1'), name: 'UPDATED WALLET 0', networkId: 1),
        WalletModel(id: 2, encryptedBool: true, pinnedBool: true, address: '0x0000000000000000000000000000000000000001', derivationPath: "m/44'/60'/0'/0/1", filesystemPath: FilesystemPath.fromString('vault1/network1/wallet2'), name: 'UPDATED WALLET 1', networkId: 1),
        // @formatter:on
      ];
      ...
      List<WalletEntity> expectedWalletsDatabaseValue = <WalletEntity>[
        // @formatter:off
        const WalletEntity(id: 1, encryptedBool: true, pinnedBool: true, address: '0x0000000000000000000000000000000000000000', derivationPath: "m/44'/60'/0'/0/0", filesystemPathString: 'vault1/network1/wallet1', name: 'UPDATED WALLET 0', networkId: 1),
        const WalletEntity(id: 2, encryptedBool: true, pinnedBool: true, address: '0x0000000000000000000000000000000000000001', derivationPath: "m/44'/60'/0'/0/1", filesystemPathString: 'vault1/network1/wallet2', name: 'UPDATED WALLET 1', networkId: 1),
        const WalletEntity(id: 3, encryptedBool: false, pinnedBool: false, address: '0x1C37924f1416fF39F74A7284429a18dbbbcc06CD', derivationPath: "m/44'/60'/0'/0/2", filesystemPathString: 'vault1/network1/wallet3', name: 'WALLET 2', networkId: 1),
        const WalletEntity(id: 4, encryptedBool: false, pinnedBool: false, address: '0x315C3d389598EAe9aA2bf5524556B9CFA857B97c', derivationPath: "m/44'/60'/0'/0/3", filesystemPathString: 'vault1/network1/group3/wallet4', name: 'WALLET 3', networkId: 1),
        const WalletEntity(id: 5, encryptedBool: false, pinnedBool: false, address: '0x569f256904bBaA2d9Cb3AF3104fCE9f0fC43F639', derivationPath: "m/44'/60'/0'/0/4", filesystemPathString: 'vault1/network1/group3/wallet5', name: 'WALLET 4', networkId: 1)
        // @formatter:on
    ...
    test('Should [SAVE wallets] if [wallets NOT EXISTS] in database', () async {
      ...
      List<WalletModel> actualWalletsToUpdate = <WalletModel>[
        // @formatter:off
        WalletModel(id: 99998, encryptedBool: true, pinnedBool: true, address: '0x0000000000000000000000000000000000000000', derivationPath: "m/44'/60'/0'/0/0", filesystemPath: FilesystemPath.fromString('vault1/network1/wallet99998'), name: 'NEW WALLET 0', networkId: 1),
        WalletModel(id: 99999, encryptedBool: true, pinnedBool: true, address: '0x0000000000000000000000000000000000000001', derivationPath: "m/44'/60'/0'/0/1", filesystemPath: FilesystemPath.fromString('vault1/network1/wallet99999'), name: 'NEW WALLET 1', networkId: 1),
        // @formatter:on
      ];
      ...
      List<WalletEntity> expectedWalletsDatabaseValue = <WalletEntity>[
        ...
        const WalletEntity(id: 4, encryptedBool: false, pinnedBool: false, address: '0x315C3d389598EAe9aA2bf5524556B9CFA857B97c', derivationPath: "m/44'/60'/0'/0/3", filesystemPathString: 'vault1/network1/group3/wallet4', name: 'WALLET 3', networkId: 1),
        const WalletEntity(id: 5, encryptedBool: false, pinnedBool: false, address: '0x569f256904bBaA2d9Cb3AF3104fCE9f0fC43F639', derivationPath: "m/44'/60'/0'/0/4", filesystemPathString: 'vault1/network1/group3/wallet5', name: 'WALLET 4', networkId: 1),
        const WalletEntity(id: 99998, encryptedBool: true, pinnedBool: true, address: '0x0000000000000000000000000000000000000000', derivationPath: "m/44'/60'/0'/0/0", filesystemPathString: 'vault1/network1/wallet99998', name: 'NEW WALLET 0', networkId: 1),
        const WalletEntity(id: 99999, encryptedBool: true, pinnedBool: true, address: '0x0000000000000000000000000000000000000001', derivationPath: "m/44'/60'/0'/0/1", filesystemPathString: 'vault1/network1/wallet99999', name: 'NEW WALLET 1', networkId: 1)
        // @formatter:on
      ];
      expect(actualWalletsDatabaseValue, expectedWalletsDatabaseValue);
    });
