...
void main() {
  ...
  group('Tests of WalletsService.getLastDerivationIndex()', () {
    test('Should [return last derivation index] if [database NOT EMPTY]', () async {
      ...
      // Act
      int actualLastDerivationIndex = await globalLocator<WalletsService>().getLastDerivationIndex(FilesystemPath.fromString('vault1/network1'), DerivationPathLastIndexExtractor());
