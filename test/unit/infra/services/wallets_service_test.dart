...
void main() {
  ...
  group('Tests of WalletsService.getLastDerivationIndex()', () {
    test('Should [return last derivation index] if [database NOT EMPTY]', () async {
      ...
      // Act
      int actualLastDerivationIndex = await globalLocator<WalletsService>().getHighestDerivationIndex(FilesystemPath.fromString('vault1/network1'), DerivationPathIndexExtractor(derivationPathTemplate: "m/44'/60'/0'/0/{{i}}"));
