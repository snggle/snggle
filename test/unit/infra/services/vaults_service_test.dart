...
void main() {
  ...
  group('Tests of VaultsService.getAllByParentPath()', () {
    test('Should [return List of VaultModel] if [given path HAS VALUES] (firstLevelBool == TRUE)', () async {
      ...
      await globalLocator<VaultsService>().getAllByParentPath(
          FilesystemPath.fromString(FilesystemStorageSubdirectoryKey.vaults.name), firstLevelBool: true);
    ...
    test('Should [return List of VaultModel] if [given path HAS VALUES] (firstLevelBool == FALSE)', () async {
      ...
      // Act
      List<VaultModel> actualVaultModelList =
      await globalLocator<VaultsService>().getAllByParentPath(const FilesystemPath.empty(), firstLevelBool: false);
  ...
  group('Tests of VaultsService.move()', () {
    test('Should [MOVE vault] if [vault EXISTS] in database', () async {
      ...
      List<VaultEntity> expectedVaultsDatabaseValue = <VaultEntity>[
        // @formatter:off
        const VaultEntity(id: 1, encryptedBool: false, pinnedBool: false, index: 0, filesystemPathString: 'vaults/new/path/vault1', fingerprint: '2429747484', name: 'VAULT 1'),
  ...
  group('Tests of VaultsService.moveAllByParentPath()', () {
    test('Should [MOVE vaults] starting with given path', () async {
      ...
      await globalLocator<VaultsService>().moveAllByParentPath(
        FilesystemPath.fromString('vaults/group1'),
      ...
      List<VaultEntity> expectedVaultsDatabaseValue = <VaultEntity>[
        ...
        const VaultEntity(id: 2, encryptedBool: false, pinnedBool: false, index: 1, filesystemPathString: 'vaults/vault2', fingerprint: '2619341544', name: 'VAULT 2'),
        const VaultEntity(id: 3, encryptedBool: false, pinnedBool: false, index: 2, filesystemPathString: 'vaults/vault3', fingerprint: '405998762', name: 'VAULT 3'),
        const VaultEntity(id: 4, encryptedBool: false, pinnedBool: false, index: 3, filesystemPathString: 'vaults/new/path/group1/vault4', fingerprint: '1024969286', name: 'VAULT 4'),
        const VaultEntity(id: 5, encryptedBool: false, pinnedBool: false, index: 4, filesystemPathString: 'vaults/new/path/group1/vault5', fingerprint: '1980042394', name: 'VAULT 5')
        // @formatter:on
      ];
  ...
  group('Tests of VaultsService.save()', () {
    test('Should [UPDATE vault] if [vault EXISTS] in database', () async {
      ...
      List<VaultEntity> expectedVaultsDatabaseValue = <VaultEntity>[
        // @formatter:off
        const VaultEntity(id: 1, encryptedBool: true, pinnedBool: true, index: 0, filesystemPathString: 'vaults/vault1', fingerprint: '2429747484', name: 'UPDATED VAULT 1'),
        const VaultEntity(id: 2, encryptedBool: false, pinnedBool: false, index: 1, filesystemPathString: 'vaults/vault2', fingerprint: '2619341544', name: 'VAULT 2'),
        const VaultEntity(id: 3, encryptedBool: false, pinnedBool: false, index: 2, filesystemPathString: 'vaults/vault3', fingerprint: '405998762', name: 'VAULT 3'),
        const VaultEntity(id: 4, encryptedBool: false, pinnedBool: false, index: 3, filesystemPathString: 'vaults/group1/vault4', fingerprint: '1024969286', name: 'VAULT 4'),
        const VaultEntity(id: 5, encryptedBool: false, pinnedBool: false, index: 4, filesystemPathString: 'vaults/group1/vault5', fingerprint: '1980042394', name: 'VAULT 5')
    ...
    test('Should [SAVE vault] if [vault NOT EXISTS] in database', () async {
      ...
      VaultModel actualNewVaultModel = VaultModel(
        ...
        pinnedBool: true,
        index: 999999,
        filesystemPath: FilesystemPath.fromString('vaults/vault999999'),
      ...
      List<VaultEntity> expectedVaultsDatabaseValue = <VaultEntity>[
        ...
        const VaultEntity(id: 4, encryptedBool: false, pinnedBool: false, index: 3, filesystemPathString: 'vaults/group1/vault4', fingerprint: '1024969286', name: 'VAULT 4'),
        const VaultEntity(id: 5, encryptedBool: false, pinnedBool: false, index: 4, filesystemPathString: 'vaults/group1/vault5', fingerprint: '1980042394', name: 'VAULT 5'),
        const VaultEntity(id: 999999, encryptedBool: true, pinnedBool: true, index: 999999, filesystemPathString: 'vaults/vault999999', fingerprint: 'NEW_FINGERPRINT', name: 'NEW VAULT 1')
        // @formatter:on
      ];
  ...
  group('Tests of VaultsService.saveAll()', () {
    test('Should [UPDATE vaults] if [vaults EXISTS] in database', () async {
      ...
      List<VaultModel> actualVaultsToUpdate = <VaultModel>[
        // @formatter:off
        VaultModel(id: 1, encryptedBool: true, pinnedBool: true, index: 0, filesystemPath: FilesystemPath.fromString('vaults/vault1'), fingerprint: '2429747484', name: 'UPDATED VAULT 1', listItemsPreview: <AListItemModel>[]),
        VaultModel(id: 2, encryptedBool: true, pinnedBool: true, index: 1, filesystemPath: FilesystemPath.fromString('vaults/vault2'), fingerprint: '2619341544', name: 'UPDATED VAULT 2', listItemsPreview: <AListItemModel>[]),
        // @formatter:on
      ];
      ...
      List<VaultEntity> expectedVaultsDatabaseValue = <VaultEntity>[
        // @formatter:off
        const VaultEntity(id: 1, encryptedBool: true, pinnedBool: true, index: 0, filesystemPathString: 'vaults/vault1', fingerprint: '2429747484', name: 'UPDATED VAULT 1'),
        const VaultEntity(id: 2, encryptedBool: true, pinnedBool: true, index: 1, filesystemPathString: 'vaults/vault2', fingerprint: '2619341544', name: 'UPDATED VAULT 2'),
        const VaultEntity(id: 3, encryptedBool: false, pinnedBool: false, index: 2, filesystemPathString: 'vaults/vault3', fingerprint: '405998762', name: 'VAULT 3'),
        const VaultEntity(id: 4, encryptedBool: false, pinnedBool: false, index: 3, filesystemPathString: 'vaults/group1/vault4', fingerprint: '1024969286', name: 'VAULT 4'),
        const VaultEntity(id: 5, encryptedBool: false, pinnedBool: false, index: 4, filesystemPathString: 'vaults/group1/vault5', fingerprint: '1980042394', name: 'VAULT 5')
        // @formatter:on
    ...
    test('Should [SAVE vaults] if [vaults NOT EXISTS] in database', () async {
      ...
      List<VaultModel> actualVaultsToUpdate = <VaultModel>[
        // @formatter:off
        VaultModel(id: 99998, encryptedBool: true, pinnedBool: true, index: 99998, filesystemPath: FilesystemPath.fromString('vaults/vault99998'), fingerprint: '', name: 'NEW VAULT 1', listItemsPreview: <AListItemModel>[]),
        VaultModel(id: 99999, encryptedBool: true, pinnedBool: true, index: 99999, filesystemPath: FilesystemPath.fromString('vaults/vault99999'), fingerprint: '', name: 'NEW VAULT 2', listItemsPreview: <AListItemModel>[]),
        // @formatter:on
      ];
      ...
      List<VaultEntity> expectedVaultsDatabaseValue = <VaultEntity>[
        ...
        const VaultEntity(id: 4, encryptedBool: false, pinnedBool: false, index: 3, filesystemPathString: 'vaults/group1/vault4', fingerprint: '1024969286', name: 'VAULT 4'),
        const VaultEntity(id: 5, encryptedBool: false, pinnedBool: false, index: 4, filesystemPathString: 'vaults/group1/vault5', fingerprint: '1980042394', name: 'VAULT 5'),
        const VaultEntity(id: 99998, encryptedBool: true, pinnedBool: true, index: 99998, filesystemPathString: 'vaults/vault99998', fingerprint: '', name: 'NEW VAULT 1'),
        const VaultEntity(id: 99999, encryptedBool: true, pinnedBool: true, index: 99999, filesystemPathString: 'vaults/vault99999', fingerprint: '', name: 'NEW VAULT 2'),
        // @formatter:on
      ];
  ...
  group('Tests of VaultsService.deleteAllByParentPath()', () {
    test('Should [REMOVE vaults] if [vaults with path EXISTS] in database', () async {
      ...
      // Act
      await globalLocator<VaultsService>().deleteAllByParentPath(FilesystemPath.fromString('vaults/group1'));
  ...
  group('Tests of VaultsService.getDuplicateVault()', () {
    test('Should [return VaultModel] if [fingerprint EXISTS] in database', () async {
      ...
      // Act
      VaultModel? actualVaultModel = await globalLocator<VaultsService>().getDuplicateVault('2429747484');
  ...
  group('Tests of VaultsService.updateFilesystemPath()', () {
    test('Should [return updated VaultModel] if [vault EXISTS] in database', () async {
      ...
      // Act
      VaultModel? actualVaultModel = await globalLocator<VaultsService>().updateFilesystemPath(1, FilesystemPath.fromString('vaults/new/vault/path'));
      ...
      VaultModel expectedVaultModel = VaultModel(
        ...
        pinnedBool: false,
        index: 0,
        filesystemPath: FilesystemPath.fromString('vaults/new/vault/path/vault1'),
        fingerprint: '2429747484',
        name: 'VAULT 1',
        listItemsPreview: <AListItemModel>[],
      );
    ...
    test('Should [throw ChildKeyNotFoundException] if [vault NOT EXISTS] in database', () async {
      ...
      // Assert
      expect(
        globalLocator<VaultsService>().updateFilesystemPath(99999, FilesystemPath.fromString('vaults/new/vault/path')),
        throwsA(isA<ChildKeyNotFoundException>()),
      );
    });
  });
