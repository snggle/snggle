...
void main() {
  ...
  group('Tests of VaultsRepository.getAllByParentPath()', () {
    test('Should [return List of VaultEntity] if [vaults with specified path NOT EMPTY]', () async {
      ...
      // Act
      List<VaultEntity> actualVaultEntityList = await globalLocator<VaultsRepository>().getAllByParentPath(FilesystemPath.fromString('vaults/group1'));
  ...
  group('Tests of VaultsRepository.getByFingerprint()', () {
    ...
    test('Should [throw ChildKeyNotFoundException] if [fingerprint NOT EXISTS] in database', () async {
      ...
      // Assert
      expect(
        globalLocator<VaultsRepository>().getByFingerprint('not_existing_fingerprint'),
        throwsA(isA<ChildKeyNotFoundException>()),
      );
    });
  });
  ...
  group('Tests of VaultsRepository.save()', () {
    ...
    test('Should [SAVE vault] if [vault NOT EXISTS] in database', () async {
      ...
      VaultEntity actualNewVaultEntity = const VaultEntity(
        ...
        pinnedBool: true,
        index: 999999,
        filesystemPathString: 'vaults/vault999999',
  ...
  group('Tests of VaultsRepository.saveAll()', () {
    ...
    test('Should [SAVE vaults] if [vaults NOT EXIST] in database', () async {
      ...
      List<VaultEntity> actualVaultsToUpdate = <VaultEntity>[
        // @formatter:off
        const VaultEntity(id: 999998, encryptedBool: true, pinnedBool: true, index: 999998, filesystemPathString: 'vaults/vault999998', fingerprint: '', name: 'NEW VAULT 1'),
        const VaultEntity(id: 999999, encryptedBool: true, pinnedBool: true, index: 999999, filesystemPathString: 'vaults/vault999999', fingerprint: '', name: 'NEW VAULT 2'),
        // @formatter:on
      ];
