...
void main() {
  ...
  group('Tests of VaultsRepository.saveAll()', () {
    ...
    test('Should [SAVE vaults] if [vaults NOT EXIST] in database', () async {
      ...
      List<VaultEntity> actualVaultsToUpdate = <VaultEntity>[
        const VaultEntity(id: 999998, encryptedBool: true, pinnedBool: true, index: 999998, filesystemPathString: 'vault999998', seedHash: 'Lki3oJlA8rXrJiViEZG3RSqGobYXZ+ki4kGabkZl/rk=', name: 'NEW VAULT 1'),
        const VaultEntity(id: 999999, encryptedBool: true, pinnedBool: true, index: 999999, filesystemPathString: 'vault999999', seedHash: 'Lki3oJlA8rXrJiViEZG3RSqGobYXZ+ki4kGabkZl/rk=', name: 'NEW VAULT 2'),
      ];
