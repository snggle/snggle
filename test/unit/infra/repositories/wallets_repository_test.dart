...
void main() {
  ...
  group('Tests of WalletsRepository.getAllDerivationPaths()', () {
    ...
    test('Should [return List of derivation paths] if [database NOT EMPTY] and [FilesystemPath NOT EMPTY]', () async {
      ...
      // Act
      List<String> actualDerivationPaths = await globalLocator<WalletsRepository>().getAllDerivationPaths(FilesystemPath.fromString('vaults/vault1/network1/group3/'));
  ...
  group('Tests of WalletsRepository.getAllByParentPath()', () {
    ...
    test('Should [return EMPTY list] if [wallets with specified path EMPTY]', () async {
      ...
      // Act
      List<WalletEntity> actualWalletEntityList = await globalLocator<WalletsRepository>().getAllByParentPath(FilesystemPath.fromString('vaults/vault1/network1'));
  ...
  group('Tests of WalletsRepository.save()', () {
    ...
    test('Should [SAVE wallet] if [wallet NOT EXISTS] in database', () async {
      ...
      WalletEntity actualNewWalletEntity = const WalletEntity(
        ...
        address: '0x0000000000000000000000000000000000000000',
        derivationPath: "m/44'/60'/0'/0/0",
        filesystemPathString: 'vaults/vault1/network1/wallet999999',
        name: 'NEW WALLET 0',
      );
  ...
  group('Tests of WalletsRepository.saveAll()', () {
    test('Should [UPDATE wallets] if [wallets EXIST] in database', () async {
      ...
      List<WalletEntity> actualWalletsToUpdate = <WalletEntity>[
        // @formatter:off
        const WalletEntity(id: 1, encryptedBool: true, pinnedBool: true, address: '0x0000000000000000000000000000000000000000', derivationPath: "m/44'/60'/0'/0/0", filesystemPathString: 'vaults/vault1/network1/wallet1', name: 'UPDATED WALLET 0'),
        const WalletEntity(id: 2, encryptedBool: true, pinnedBool: true, address: '0x1111111111111111111111111111111111111111', derivationPath: "m/44'/60'/0'/0/1", filesystemPathString: 'vaults/vault1/network1/wallet2', name: 'UPDATED WALLET 1'),
        // @formatter:on
      ];
    ...
    test('Should [SAVE wallets] if [wallets NOT EXIST] in database', () async {
      ...
      List<WalletEntity> actualWalletsToSave = <WalletEntity>[
        // @formatter:off
        const WalletEntity(id: 999998, encryptedBool: true, pinnedBool: true, address: '0x0000000000000000000000000000000000000000', derivationPath: "m/44'/60'/0'/0/0", filesystemPathString: 'vaults/vault1/network1/wallet999998', name: 'NEW WALLET 0'),
        const WalletEntity(id: 999999, encryptedBool: true, pinnedBool: true, address: '0x1111111111111111111111111111111111111111', derivationPath: "m/44'/60'/0'/0/1", filesystemPathString: 'vaults/vault1/network1/wallet999999', name: 'NEW WALLET 1'),
        // @formatter:on
      ];
