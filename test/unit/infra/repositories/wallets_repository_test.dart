  ...
  group('Tests of WalletsRepository.getAll()', () {
    test('Should [return List of WalletEntity] if ["wallets" key EXISTS] in database and [HAS VALUES]', () async {
      ...
      List<WalletEntity> expectedWalletEntityList = <WalletEntity>[
        const WalletEntity(index: 0, uuid: '4e66ba36-966e-49ed-b639-191388ce38de', parentPath: '04b5440e-e398-4520-9f9b-f0eea2d816e6', address: 'kira1q4ypasn8pak72h0dsppywd33n5rt66krgdt3np', derivationPath: "m/44'/118'/0'/0/0"),
        const WalletEntity(index: 1, uuid: '3e7f3547-d78f-4dda-a916-3e9eabd4bfee', parentPath: '04b5440e-e398-4520-9f9b-f0eea2d816e6', address: 'kira1skj2f63ztaxk2q43pm2tg7t09r0whf5cadszdn', derivationPath: "m/44'/118'/0'/0/1"),
        const WalletEntity(index: 0, uuid: '4d02947e-c838-4a77-bef3-0ffbdb1c7525', parentPath: '5f5332fb-37c1-4352-9153-d43692615f0f', address: 'kira15808n8vfcf3m88r5jxnq47gjel5lvmxadmsqt5', derivationPath: "m/44'/118'/0'/0/0"),
        const WalletEntity(index: 1, uuid: 'ef63ccfc-c3da-4212-9dc1-693a9e75e90b', parentPath: '5f5332fb-37c1-4352-9153-d43692615f0f', address: 'kira1t7lspdwnhjwx23e2r3l04wn6uuhyt60ljkqdgl', derivationPath: "m/44'/118'/0'/0/1"),
      ];
      // @formatter:on
