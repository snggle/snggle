...
void main() {
  ...
  group('Tests of WalletsRepository.getAllDerivationPaths()', () {
    ...
    test('Should [return List of derivation paths] if [database NOT EMPTY] and [FilesystemPath NOT EMPTY]', () async {
      ...
      // Act
      List<String> actualDerivationPaths =
      await globalLocator<WalletsRepository>().getAllDerivationPaths(FilesystemPath.fromString('vault1/network1/group3/'));
  ...
  group('Tests of WalletsRepository.getAllByParentPath()', () {
    ...
    test('Should [return EMPTY list] if [wallets with specified path EMPTY]', () async {
      ...
      // Act
      List<WalletEntity> actualWalletEntityList =
      await globalLocator<WalletsRepository>().getAllByParentPath(FilesystemPath.fromString('vault1/network1'));
  ...
  group('Tests of WalletsRepository.saveAll()', () {
    test('Should [UPDATE wallets] if [wallets EXIST] in database', () async {
      ...
      List<WalletEntity> actualWalletsToUpdate = <WalletEntity>[
        // @formatter:off
        WalletEntity(id: 1, encryptedBool: true, pinnedBool: true, address: '0x0000000000000000000000000000000000000000', derivationPath: "m/44'/60'/0'/0/0", filesystemPathString: 'vault1/network1/wallet1', name: 'UPDATED WALLET 0'),
        WalletEntity(id: 2, encryptedBool: true, pinnedBool: true, address: '0x1111111111111111111111111111111111111111', derivationPath: "m/44'/60'/0'/0/1", filesystemPathString: 'vault1/network1/wallet2', name: 'UPDATED WALLET 1'),
        // @formatter:on
      ];
    ...
    test('Should [SAVE wallets] if [wallets NOT EXIST] in database', () async {
      ...
      List<WalletEntity> actualWalletsToSave = <WalletEntity>[
        // @formatter:off
        WalletEntity(id: 0, encryptedBool: true, pinnedBool: true, address: '0x0000000000000000000000000000000000000000', derivationPath: "m/44'/60'/0'/0/0", filesystemPathString: 'vault1/network1/wallet999998', name: 'NEW WALLET 0'),
        WalletEntity(id: 0, encryptedBool: true, pinnedBool: true, address: '0x1111111111111111111111111111111111111111', derivationPath: "m/44'/60'/0'/0/1", filesystemPathString: 'vault1/network1/wallet999999', name: 'NEW WALLET 1'),
        // @formatter:on
      ];
      ...
      List<WalletEntity> expectedWalletsDatabaseValue = <WalletEntity>[
        ...
        WalletEntity(id: 5, encryptedBool: false, pinnedBool: false, address: '0x569f256904bBaA2d9Cb3AF3104fCE9f0fC43F639', derivationPath: "m/44'/60'/0'/0/4", filesystemPathString: 'vault1/network1/group3/wallet5', name: 'WALLET 4'),
        WalletEntity(id: 6, encryptedBool: false, pinnedBool: false, address: '2xGD7cWtwpmCpW2NvT9EJt96eDavS3suVgQNVaBU4A19', derivationPath: "m/44'/501'/0'/0'", filesystemPathString: 'vault1/network10/wallet6', name: 'WALLET 5'),
        WalletEntity(id: 7, encryptedBool: true, pinnedBool: true, address: '0x0000000000000000000000000000000000000000', derivationPath: "m/44'/60'/0'/0/0", filesystemPathString: 'vault1/network1/wallet999998', name: 'NEW WALLET 0'),
        WalletEntity(id: 8, encryptedBool: true, pinnedBool: true, address: '0x1111111111111111111111111111111111111111', derivationPath: "m/44'/60'/0'/0/1", filesystemPathString: 'vault1/network1/wallet999999', name: 'NEW WALLET 1'),
        // @formatter:on
      ];
