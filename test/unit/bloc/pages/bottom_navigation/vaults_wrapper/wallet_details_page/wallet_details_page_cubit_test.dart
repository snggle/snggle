...
void main() {
  ...
  group('Tests of WalletDetailsPageCubit process (Ethereum)', () {
    setUpAll(() {
      WalletModel actualWalletModelEthereum = WalletModel(
        id: 1,
        encryptedBool: false,
        pinnedBool: false,
      ...
      actualWalletDetailsPageCubit = WalletDetailsPageCubit(walletModel: actualWalletModelEthereum);
      globalLocator<ActiveWalletController>().setActiveWallet(walletModel: actualWalletModelEthereum);
    });
    ...
    group('Tests of WalletDetailsPageCubit.init()', () {
      test('Should [emit WalletDetailsPageState] with TransactionHistoryModel', () async {
        ...
        WalletDetailsPageState expectedWalletDetailsPageState = WalletDetailsPageState(
          transactions: <ATransactionModel>[transactionModel1, transactionModel2, transactionModel3, transactionModel4],
        );
      ...
      test('Should [emit WalletDetailsPageState] with [all transactions SELECTED]', () async {
        ...
        WalletDetailsPageState expectedWalletDetailsPageState = WalletDetailsPageState(
          selectionModel: SimpleSelectionModel<ATransactionModel>(
            allItemsCount: 4,
            selectedItems: <ATransactionModel>[transactionModel1, transactionModel2, transactionModel3, transactionModel4],
          ),
          transactions: <ATransactionModel>[transactionModel1, transactionModel2, transactionModel3, transactionModel4],
        );
    ...
    group('Tests of WalletDetailsPageCubit.select()', () {
      test('Should [emit WalletDetailsPageState] with specified transaction selected', () async {
        ...
        WalletDetailsPageState expectedWalletDetailsPageState = WalletDetailsPageState(
          selectionModel: SimpleSelectionModel<ATransactionModel>(
            allItemsCount: 4,
            selectedItems: <ATransactionModel>[transactionModel1],
          ),
          transactions: <ATransactionModel>[transactionModel1, transactionModel2, transactionModel3, transactionModel4],
        );
    ...
    group('Tests of WalletDetailsPageCubit.deleteSelected()', () {
      test('Should [emit WalletDetailsPageState] without deleted transaction', () async {
        ...
        // Assert
        WalletDetailsPageState expectedWalletDetailsPageState = WalletDetailsPageState(
          transactions: <ATransactionModel>[transactionModel2, transactionModel3, transactionModel4],
        );
  ...
  group('Tests of WalletDetailsPageCubit process (Solana)', () {
    setUpAll(() {
      WalletModel actualWalletModelSolana = WalletModel(
        id: 2,
        encryptedBool: false,
        pinnedBool: false,
      ...
      actualWalletDetailsPageCubit = WalletDetailsPageCubit(walletModel: actualWalletModelSolana);
      globalLocator<ActiveWalletController>().setActiveWallet(walletModel: actualWalletModelSolana);
    });
    ...
    group('Tests of WalletDetailsPageCubit.init()', () {
      test('Should [emit WalletDetailsPageState] with TransactionHistoryModel', () async {
        ...
        // Assert
        WalletDetailsPageState expectedWalletDetailsPageState = WalletDetailsPageState(
          transactions: <ATransactionModel>[transactionModel5, transactionModel6],
        );
    ...
    group('Tests of WalletDetailsPageCubit.selectAll()', () {
      test('Should [emit WalletDetailsPageState] with [all transactions SELECTED]', () async {
        ...
        WalletDetailsPageState expectedWalletDetailsPageState = WalletDetailsPageState(
          selectionModel: SimpleSelectionModel<ATransactionModel>(
            allItemsCount: 2,
            selectedItems: <ATransactionModel>[transactionModel5, transactionModel6],
          ),
          transactions: <ATransactionModel>[transactionModel5, transactionModel6],
        );
    ...
    group('Tests of WalletDetailsPageCubit.select()', () {
      test('Should [emit WalletDetailsPageState] with specified transaction selected', () async {
        // Act
        actualWalletDetailsPageCubit.select(transactionModel5);
        WalletDetailsPageState actualWalletDetailsPageState = actualWalletDetailsPageCubit.state;
        ...
        WalletDetailsPageState expectedWalletDetailsPageState = WalletDetailsPageState(
          selectionModel: SimpleSelectionModel<ATransactionModel>(
            allItemsCount: 2,
            selectedItems: <ATransactionModel>[transactionModel5],
          ),
          transactions: <ATransactionModel>[transactionModel5, transactionModel6],
        );
    ...
    group('Tests of WalletDetailsPageCubit.unselect()', () {
      test('Should [emit WalletDetailsPageState] with specified transaction unselected', () async {
        // Act
        actualWalletDetailsPageCubit.unselect(transactionModel5);
        WalletDetailsPageState actualWalletDetailsPageState = actualWalletDetailsPageCubit.state;
    ...
    group('Tests of WalletDetailsPageCubit.deleteSelected()', () {
      test('Should [emit WalletDetailsPageState] without deleted transaction', () async {
        ...
        // Assert
        WalletDetailsPageState expectedWalletDetailsPageState = WalletDetailsPageState(
          transactions: <ATransactionModel>[transactionModel6],
        );
