...
void main() {
  ...
  group('Tests of WalletDetailsPageCubit process (Ethereum)', () {
    setUpAll(() {
      WalletModel actualWalletModel1 = WalletModel(
        id: 1,
        encryptedBool: false,
        pinnedBool: false,
      ...
      actualWalletDetailsPageCubit = WalletDetailsPageCubit(walletModel: actualWalletModel1);
      globalLocator<ActiveWalletController>().setActiveWallet(walletModel: actualWalletModel1);
    });
  ...
  group('Tests of WalletDetailsPageCubit process (Solana)', () {
    setUpAll(() {
      WalletModel actualWalletModel2 = WalletModel(
        id: 2,
        encryptedBool: false,
        pinnedBool: false,
      ...
      actualWalletDetailsPageCubit = WalletDetailsPageCubit(walletModel: actualWalletModel2);
      globalLocator<ActiveWalletController>().setActiveWallet(walletModel: actualWalletModel2);
    });
