...
void main() {
  ...
  group('Tests of WalletConnectPageCubit process', () {
    test('Should [return WalletConnectPageState] with WalletExportType.qr as default state', () {
      // Act
      WalletConnectPageState actualWalletConnectPageState = actualWalletConnectPageCubit.state;

      // Assert
      WalletConnectPageState expectedWalletConnectPageState = const WalletConnectPageState(walletExportType: WalletExportType.qr);

      expect(actualWalletConnectPageState, expectedWalletConnectPageState);
    });

    test('Should [return WalletConnectPageState] with WalletExportType.hardware', () {
      // Act
      actualWalletConnectPageCubit.changeExportType(WalletExportType.hardware);
      WalletConnectPageState actualWalletConnectPageState = actualWalletConnectPageCubit.state;

      // Assert
      WalletConnectPageState expectedWalletConnectPageState = const WalletConnectPageState(walletExportType: WalletExportType.hardware);

      expect(actualWalletConnectPageState, expectedWalletConnectPageState);
    });

    test('Should [return WalletConnectPageState] with WalletExportType.qr', () {
      // Act
      actualWalletConnectPageCubit.changeExportType(WalletExportType.qr);
      WalletConnectPageState actualWalletConnectPageState = actualWalletConnectPageCubit.state;
    ...
    test('Should [return CborCryptoHDKey] with extended public key for all wallets', () async {
      // Act
      CborCryptoHDKey actualCborCryptoHDKey = await actualWalletConnectPageCubit.getCborCryptoHDKey(exportAllBool: true);
    ...
    test('Should [return CborCryptoHDKey] with extended public key for single wallet', () async {
      // Act
      CborCryptoHDKey actualCborCryptoHDKey = await actualWalletConnectPageCubit.getCborCryptoHDKey(exportAllBool: false);
