...
Future<void> main() async {
  ...
  group('Tests of [SecretsAuthPageCubit]', () {
    group('Tests of [SecretsAuthPageCubit] when [pin CORRECT]', () {
      setUpAll(() {
      ...
      test('Should [return PasswordEntryResultModel] if provided [password VALID]', () async {
        // Act
        PasswordEntryResultModel actualPasswordEntryResultModel = await actualSecretsAuthPageCubit.authenticate();
