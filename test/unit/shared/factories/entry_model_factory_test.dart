...
void main() {
  ...
  group('Tests of EntryModelFactory.createNewEntry()', () {
    test('Should [return EntryModel] with initial values (database EMPTY)',
        () async {
      // Act
    ...
    test('Should [return EntryModel] with initial values (database NOT EMPTY)',
        () async {
      // Arrange
      await globalLocator<EntryModelFactory>().createNewEntry(
        FilesystemPath.fromString('entries'),
  ...
  group('Tests of EntryModelFactory.createFromEntities()', () {
    test('Should [return List of EntryModel] from given List of EntryEntity',
        () async {
      // Arrange
      ...
      // Act
      List<EntryModel> actualEntryModelList =
          await globalLocator<EntryModelFactory>()
              .createFromEntities(actualEntryEntityList);
  ...
  group('Tests of EntryModelFactory.createFromEntity()', () {
    test('Should [return EntryModel] from given EntryEntity', () async {
      ...
      // Act
      EntryModel actualEntryModel = await globalLocator<EntryModelFactory>()
          .createFromEntity(actualEntryEntity);
