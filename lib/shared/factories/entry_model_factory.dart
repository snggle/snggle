...
class EntryModelFactory {
  ...
  Future<EntryModel> createNewEntry(FilesystemPath parentFilesystemPath,
      [String? name, String? website, String? email, String? username, String? password]) async {
    ...
    EntryModel entryModel = EntryModel(
      ...
      name: name,
      website: website,
      emailExistsBool: email?.isNotEmpty == true,
      usernameExistsBool: username?.isNotEmpty == true,
      passwordExistsBool: password?.isNotEmpty == true,
    );
