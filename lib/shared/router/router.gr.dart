...
import '../../views/pages/bottom_navigation/apps_page.dart' as _i8;
import '../../views/pages/bottom_navigation/bottom_navigation_wrapper.dart'
    as _i4;
import '../../views/pages/bottom_navigation/secrets_page.dart' as _i7;
import '../../views/pages/bottom_navigation/settings_page.dart' as _i9;
import '../../views/pages/bottom_navigation/vault_list_page.dart' as _i6;
import '../../views/pages/qr_code_generate_page.dart' as _i5;
...
class AppRouter extends _i10.RootStackRouter {
  ...
  final Map<String, _i10.PageFactory> pagesMap = {
    ...
    QrCodeGenerateRoute.name: (routeData) {
      return _i10.MaterialPageX<void>(
        routeData: routeData,
        child: const _i5.QrCodeGeneratePage(),
      );
    },
    VaultListRoute.name: (routeData) {
      return _i10.MaterialPageX<void>(
        routeData: routeData,
        child: const _i6.VaultListPage(),
      );
    },
...
/// generated route for
/// [_i2.AppSetupPinPage]
class AppSetupPinRoute extends _i10.PageRouteInfo<void> {
...
/// generated route for
/// [_i3.AppAuthPage]
class AppAuthRoute extends _i10.PageRouteInfo<void> {
  const AppAuthRoute()
      : super(
          AppAuthRoute.name,
          path: '/app-auth-page',
...
class BottomNavigationRoute extends _i10.PageRouteInfo<void> {
  const BottomNavigationRoute({List<_i10.PageRouteInfo>? children})
      : super(
          BottomNavigationRoute.name,
          path: '/bottom-navigation-wrapper',
...
/// generated route for
/// [_i5.QrCodeGeneratePage]
class QrCodeGenerateRoute extends _i10.PageRouteInfo<void> {
  const QrCodeGenerateRoute()
      : super(
          QrCodeGenerateRoute.name,
          path: '/qr-code-generate-page',
        );

  static const String name = 'QrCodeGenerateRoute';
}

/// generated route for
/// [_i6.VaultListPage]
class VaultListRoute extends _i10.PageRouteInfo<void> {
...
/// generated route for
/// [_i7.SecretsPage]
class SecretsRoute extends _i10.PageRouteInfo<void> {
  const SecretsRoute()
      : super(
          SecretsRoute.name,
          path: 'secrets-page',
...
/// generated route for
/// [_i8.AppsPage]
class AppsRoute extends _i10.PageRouteInfo<void> {
  const AppsRoute()
      : super(
          AppsRoute.name,
          path: 'apps-page',
