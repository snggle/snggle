...
class WalletDetailsRouteArgs {
  ...
  @override
  String toString() {
    return 'WalletDetailsRouteArgs{vaultModel: $vaultModel, walletModel: $walletModel, vaultPasswordModel: $vaultPasswordModel, walletDetailsPageCubit: $walletDetailsPageCubit, networkTemplateModel: $networkTemplateModel, key: $key}';
  }
}
