...
import 'package:snggle/views/pages/bottom_navigation/vaults_wrapper/wallet_list_page/wallet_list_page.dart'
    as _i21;
import 'package:snggle/views/pages/bottom_navigation/vaults_wrapper/wallet_select_item_list_page/wallet_select_item_list_page.dart'
    as _i22;
...
abstract class $AppRouter extends _i23.RootStackRouter {
  ...
  final Map<String, _i23.PageFactory> pagesMap = {
    ...
    WalletSelectItemListRoute.name: (routeData) {
      final args = routeData.argsAs<WalletSelectItemListRouteArgs>();
      return _i23.AutoRoutePage<List<_i25.WalletModel>>(
        routeData: routeData,
        child: _i22.WalletSelectItemListPage(
          name: args.name,
          vaultModel: args.vaultModel,
          filesystemPath: args.filesystemPath,
          networkGroupModel: args.networkGroupModel,
...
class EthereumTransactionDetailsRoute
  ...
  EthereumTransactionDetailsRoute({
    required _i26.EthereumTransactionModel transactionModel,
...
class EthereumTransactionDetailsRouteArgs {
  ...
  final _i26.EthereumTransactionModel transactionModel;
  ...
  @override
  String toString() {
    return 'EthereumTransactionDetailsRouteArgs{transactionModel: $transactionModel, networkTemplateModel: $networkTemplateModel, key: $key}';
  }
}
...
class SolanaTransactionDetailsRoute
  ...
  SolanaTransactionDetailsRoute({
    required _i31.SolanaTransactionModel transactionModel,
    required _i27.NetworkTemplateModel networkTemplateModel,
    _i28.Key? key,
    List<_i23.PageRouteInfo>? children,
  }) : super(
...
class SolanaTransactionDetailsRouteArgs {
  ...
  final _i31.SolanaTransactionModel transactionModel;
  ...
  @override
  String toString() {
    return 'SolanaTransactionDetailsRouteArgs{transactionModel: $transactionModel, networkTemplateModel: $networkTemplateModel, key: $key}';
  }
}
...
/// generated route for
/// [_i22.WalletSelectItemListPage]
class WalletSelectItemListRoute
    extends _i23.PageRouteInfo<WalletSelectItemListRouteArgs> {
  WalletSelectItemListRoute({
    ...
    List<_i23.PageRouteInfo>? children,
          ...
          WalletSelectItemListRoute.name,
          args: WalletSelectItemListRouteArgs(
            name: name,
            vaultModel: vaultModel,
            filesystemPath: filesystemPath,
            networkGroupModel: networkGroupModel,
  ...
  static const String name = 'WalletSelectItemListRoute';

  static const _i23.PageInfo<WalletSelectItemListRouteArgs> page =
      _i23.PageInfo<WalletSelectItemListRouteArgs>(name);
}

class WalletSelectItemListRouteArgs {
  const WalletSelectItemListRouteArgs({
    required this.name,
    required this.vaultModel,
    required this.filesystemPath,
    required this.networkGroupModel,
  ...
  @override
  String toString() {
    return 'WalletSelectItemListRouteArgs{name: $name, vaultModel: $vaultModel, filesystemPath: $filesystemPath, networkGroupModel: $networkGroupModel, key: $key}';
  }
}
