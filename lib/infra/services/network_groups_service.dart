...
class NetworkGroupsService implements IListItemsService<NetworkGroupModel> {
  ...
  @override
  Future<List<NetworkGroupModel>> getAllByParentPath(
  ...
  Future<void> moveAllByParentPath(FilesystemPath previousFilesystemPath, FilesystemPath newFilesystemPath) async {
    List<NetworkGroupModel> networkGroupModelsToMove = await getAllByParentPath(
      previousFilesystemPath,
      firstLevelBool: false,
      previewEmptyBool: true,
    );
  ...
  Future<void> deleteAllByParentPath(FilesystemPath parentFilesystemPath) async {
    ...
    networkGroupModels.sort(
      (NetworkGroupModel a, NetworkGroupModel b) => b.filesystemPath.fullPath.length.compareTo(a.filesystemPath.fullPath.length),
    );
