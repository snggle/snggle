...
class VaultListPageCubit extends Cubit<List<VaultModel>> {
  ...
  Future<void> createNewVault() async {
    ...
    VaultSecretsModel vaultSecretsModel = VaultSecretsModel(path: newVaultModel.uuid, mnemonicModel: mnemonicModel);
  ...
  Future<void> deleteVault(VaultModel vaultModel) async {
    ...
    await _secretsService.deleteSecrets(vaultModel.uuid);
    await refresh();
  }
