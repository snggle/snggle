...
class _MnemonicFormGeneratedState extends State<MnemonicFormGenerated> {
  ...
  late final MnemonicFormGeneratedCubit mnemonicFormGeneratedCubit;
  ...
  void dispose() {
    ...
    mnemonicFormGeneratedCubit.close();
    super.dispose();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<MnemonicFormGeneratedCubit, MnemonicFormGeneratedState>(
      bloc: mnemonicFormGeneratedCubit,
      builder: (BuildContext context, MnemonicFormGeneratedState mnemonicFormGeneratedState) {
        return ScrollableLayout(
              ...
              builder: (BuildContext context, bool scrolledBottomBool, _) {
                return BottomTooltipItem(
                  ...
                  onTap: scrolledBottomBool
                      ? (statementAcceptedBool && mnemonicFormGeneratedCubit.state.repeatedVaultModel == null)
                          ? _pressFinishButton
                          : null
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              children: <Widget>[
                if (mnemonicFormGeneratedCubit.state.repeatedVaultModel != null) ...<Widget>[
                  const Row(
                  ...
                  Text(
                    'Repeated vault: ${mnemonicFormGeneratedCubit.state.repeatedVaultModel!.name}',
                ...
                LabelWrapperVertical.textField(
                  ...
                  child: CustomTextField(
                    ...
                    textEditingController: mnemonicFormGeneratedCubit.vaultNameTextEditingController,
                  ),
                ),
                if (mnemonicFormGeneratedCubit.state.vaultNameExistsBool == true)
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return LabelWrapperVertical.textField(
                      ...
                      child: CustomTextField(
                        ...
                        textEditingController: TextEditingController(text: mnemonicFormGeneratedCubit.state.mnemonic[index]),
  ...
  Future<void> _pressFinishButton() async {
    await CustomLoadingDialog.show<void>(
      context: context,
      title: 'Saving...',
      futureFunction: mnemonicFormGeneratedCubit.saveMnemonic,
      onSuccess: (_) async {
        if (mnemonicFormGeneratedCubit.state.repeatedVaultModel != null) {
