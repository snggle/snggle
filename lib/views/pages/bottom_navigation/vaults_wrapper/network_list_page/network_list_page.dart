              ...
              SliverFillRemaining(
                child: Center(
                  child: Padding(
                    ...
                    child: IconButton(
                      onPressed: () => networkListPageCubit.createNewNetworkGroup(NetworkConfigModel.ethereum),
              ...
              SliverPageList(
                ...
                creationButton: HorizontalListItemLayout(
                  iconWidget: ListItemCreationButton(
                    ...
                    onTap: () => networkListPageCubit.createNewNetworkGroup(NetworkConfigModel.ethereum),
                  ),
                ),
