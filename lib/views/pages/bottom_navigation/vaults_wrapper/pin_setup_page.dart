...
import 'package:snggle/bloc/secrets_setup_pin_page/a_secrets_setup_pin_page_state.dart';
import 'package:snggle/bloc/secrets_setup_pin_page/secrets_setup_pin_page_cubit.dart';
import 'package:snggle/bloc/secrets_setup_pin_page/states/secrets_setup_pin_page_confirm_pin_state.dart';
import 'package:snggle/bloc/secrets_setup_pin_page/states/secrets_setup_pin_page_enter_pin_state.dart';
import 'package:snggle/bloc/secrets_setup_pin_page/states/secrets_setup_pin_page_invalid_pin_state.dart';
import 'package:snggle/bloc/secrets_setup_pin_page/states/secrets_setup_pin_page_loading_state.dart';
...
class SecretsSetupPinPage<T extends ASecretsModel> extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _SecretsSetupPinPageState<T>();
}

class _SecretsSetupPinPageState<T extends ASecretsModel> extends State<SecretsSetupPinPage<T>> {
  late final SecretsSetupPinPageCubit<T> secretsSetupPinPageCubit = SecretsSetupPinPageCubit<T>(containerModels: widget.containerModels);

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<SecretsSetupPinPageCubit<T>, ASecretsSetupPinPageState>(
