...
class SolanaTxConfirmationScaffold extends StatefulWidget {
  final String title;
  final SolanaTransactionModel transactionModel;
  final VoidCallback onSignPressed;

  const SolanaTxConfirmationScaffold({
    required this.title,
  ...
  @override
  State<StatefulWidget> createState() => _SolanaTxConfirmationScaffoldState();
}

class _SolanaTxConfirmationScaffoldState extends State<SolanaTxConfirmationScaffold> {
