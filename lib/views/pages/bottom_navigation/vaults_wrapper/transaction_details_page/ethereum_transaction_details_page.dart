...
@RoutePage()
class EthereumTransactionDetailsPage extends StatefulWidget {
  final EthereumTransactionModel ethereumTransactionModel;
  final NetworkTemplateModel networkTemplateModel;

  const EthereumTransactionDetailsPage({
  ...
  @override
  State<StatefulWidget> createState() => _EthereumTransactionDetailsPageState();
}

class _EthereumTransactionDetailsPageState extends State<EthereumTransactionDetailsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    String? senderAddress = widget.ethereumTransactionModel.senderAddress;
    String? recipientAddress = widget.ethereumTransactionModel.recipientAddress;
    String? contractAddress = widget.ethereumTransactionModel.contractAddress;

    String? fee = widget.ethereumTransactionModel.fee;
    String? amount = widget.ethereumTransactionModel.amount;

    Uint8List? abiFunctionBytes =
        widget.ethereumTransactionModel.functionData != null ? HexCodec.decode(widget.ethereumTransactionModel.functionData!) : null;
    ...
    String? signDate =
        widget.ethereumTransactionModel.signDate != null ? DateFormat('dd/MM/yy HH:mm').format(widget.ethereumTransactionModel.signDate!) : null;
    String signDataType = switch (widget.ethereumTransactionModel.signDataType) {
      SignDataType.typedTransaction => 'TRANSACTION',
      SignDataType.rawBytes => 'PLAIN TEXT',
    };

    String? message = widget.ethereumTransactionModel.message;
    ...
    String? signature = widget.ethereumTransactionModel.signature;
