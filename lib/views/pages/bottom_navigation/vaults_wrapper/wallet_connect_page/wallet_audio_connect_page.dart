...
class WalletAudioConnectPage extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _WalletAudioConnectPageState();
}

class _WalletAudioConnectPageState extends State<WalletAudioConnectPage> {
  @override
  Widget build(BuildContext context) {
    ThemeData theme = Theme.of(context);

    return AudioPlayerScaffold(
      title: 'Audio Connect',
      msgUint8List: widget.cborCryptoHDKey.toSerializedCbor(includeTagBool: false),
