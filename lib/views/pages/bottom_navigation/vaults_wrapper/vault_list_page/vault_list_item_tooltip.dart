...
class VaultListItemTooltip extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _VaultListItemTooltipState();
}

class _VaultListItemTooltipState extends State<VaultListItemTooltip> {
  @override
