...
class WalletListItemTooltip extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _WalletListItemTooltipState();
}

class _WalletListItemTooltipState extends State<WalletListItemTooltip> {
  @override
