  ...
  Widget build(BuildContext context) {
    ...
    return TextField(
      ...
      style: widget.enabledBool
          ...
          : theme.textTheme.bodyMedium?.copyWith(color: AppColors.middleGrey),
      ...
      decoration: InputDecoration(
        ...
        enabledBorder: widget.inputBorder ?? UnderlineInputBorder(borderSide: BorderSide(color: AppColors.middleGrey)),
        focusedBorder: widget.inputBorder ?? UnderlineInputBorder(borderSide: BorderSide(color: AppColors.middleGrey)),
        disabledBorder: widget.inputBorder ?? UnderlineInputBorder(borderSide: BorderSide(color: AppColors.middleGrey)),
      ),
    );
  }
