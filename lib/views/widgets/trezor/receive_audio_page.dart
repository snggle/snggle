...
class ReceiveAudioPage extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _ReceiveAudioPageState();
}

class _ReceiveAudioPageState extends State<ReceiveAudioPage> {
              ...
              children: <Widget>[
                ...
                if (state is ReceiveSectionResultState)
                  Positioned(
                    ...
                    left: 0,
                    right: 0,
                    child: state.brokenFramesCount > 0
                        ? ElevatedButton(
                            onPressed: _receiveSectionCubit.startRecording,
                            child: const Text('Try again'),
                          )
                        : ElevatedButton(onPressed: onPressed, child: const Text('Proceed')),
                  ),
              ],
            ),
          );
