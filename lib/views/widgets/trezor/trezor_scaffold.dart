...
class TrezorScaffold extends StatefulWidget {
  final String title;
  final String msg;
  final UR? ur;
  final Widget child;
  ...
  const TrezorScaffold.fromUniformResource({
    required this.title,
    required this.msg,
    required this.ur,
    required this.child,
  ...
  @override
  State<StatefulWidget> createState() => _TrezorScaffoldState();
}

class _TrezorScaffoldState extends State<TrezorScaffold> {
